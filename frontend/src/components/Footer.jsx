...
const Footer = () => {
  return (
    <Box
      sx={{ bgcolor: "#000000", color: "text.secondary", py: 8, mt: "auto" }}
    >
      <Container maxWidth="xl">
        <Grid container spacing={4} justifyContent="space-between">
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2" paragraph sx={{ maxWidth: 300, mb: 3 }}>
              Accelerating materials discovery with state-of-the-art machine
              learning models.
            </Typography>
        ...
        >
          ...
          <Typography variant="body2">Designed with precision.</Typography>
        </Box>
      </Container>
    </Box>
  );
